      ...
      <aside
        ...
        <div className={'flex flex-col justify-center items-center'}>
          <ul className="w-full h-full">
            <li
              className={`px-2.5 py-2 font-bold border-b-2 border-[var( --border-card)] text-[var(--text-color)] ${activeTab[0] ? `bg-primary text-white` : `bg-white text-text`}`}
              onClick={() => activeCurrTab(0)}>
              <Link href={'/manager'}>Trang chủ</Link>
            </li>
            <li
              className={`px-2.5 py-2 font-bold border-b-2 border-[var( --border-card)] text-[var(--text-color)] ${activeTab[1] ? `bg-primary text-white` : `bg-white text-text`} `}
              onClick={() => activeCurrTab(1)}>
              <Link href={'/manager/branch_manager'}>Chi nhánh</Link>
            </li>
            <li
              className={`px-2.5 py-2 font-bold border-b-2 border-[var( --border-card)] text-[var(--text-color)] ${activeTab[2] ? `bg-primary text-white` : `bg-white text-text`}`}
              onClick={() => activeCurrTab(2)}>
              <Link href={'/manager/finance_manager'}>Doanh thu</Link>
            </li>
            <li
              className={`px-2.5 py-2 font-bold border-b-2 border-[var( --border-card)] text-[var(--text-color)] ${activeTab[3] ? `bg-primary text-white` : `bg-white text-text`}`}
              onClick={() => activeCurrTab(3)}>
              <Link href={'/manager/category_manager'}>Danh mục</Link>
            </li>
            <li
              className={`px-2.5 py-2 font-bold border-b-2 border-[var( --border-card)] text-[var(--text-color)] ${activeTab[4] ? `bg-primary text-white` : `bg-white text-text`}`}
              onClick={() => activeCurrTab(4)}>
              <Link href={'/manager/food_manager'}>Thực đơn</Link>
            </li>
            <li
              className={`px-2.5 py-2 font-bold border-b-2 border-[var( --border-card)] text-[var(--text-color)] ${activeTab[5] ? `bg-primary text-white` : `bg-white text-text`}`}
              onClick={() => activeCurrTab(5)}>
              <Link href={'/manager/user_manager'}>Tài khoản</Link>
            </li>
            <li
              className={`px-2.5 py-2 font-bold border-b-2 border-[var( --border-card)] text-[var(--text-color)] ${activeTab[6] ? `bg-primary text-white` : `bg-white text-text`}`}
              onClick={() => activeCurrTab(6)}>
              <Link href={'/manager/setting'}>Hồ sơ</Link>
            </li>
            <li
              className={`px-2.5 py-2 font-bold border-b-2 border-[var( --border-card)] text-[var(--text-color)] ${activeTab[7] ? `bg-primary text-white` : `bg-white text-text`}`}
      ...
      <div className="flex flex-col w-full h-full">
        <header className="hidden min-w-full bg-gray-200 p-3 sm:flex flex-row justify-between items-center">
          ...
          <div className={'flex flex-row justify-center items-center'}>
            <BsQuestionCircleFill color={'gray'} size={20} className={'mx-1'} />
            <div className={'relative w-fit mx-1'}>
              <BsBellFill color={'gray'} size={20} className={'mx-1'} />
